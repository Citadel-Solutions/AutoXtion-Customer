//
//  PromotionsVaraibles.swift
//  AutoXtion Customer
//
//  Created by Vaibhav Kapur on 26/08/2016.
...
struct PromotionsVariables {
    ...
    static var couponCodeRequest = ""
    
    //static var requestServiceTypeList: Set<String> = ["Rock", "Classical", "Hip hop"]
